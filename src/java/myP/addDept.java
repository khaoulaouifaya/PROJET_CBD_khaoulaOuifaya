...
public class addDept extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into  dept values(seq_dept.nextval,?) ");
            ps.setString(1, request.getParameter("fieldDept"));

            ps.executeUpdate();
            RequestDispatcher rd=request.getRequestDispatcher("/jsp/pricipal.jsp");
            request.setAttribute("msg", "departement ajouter avec succees !");
