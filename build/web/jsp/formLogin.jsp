...
<html>
    ...
    <body >
          <%if(request.getAttribute("msg")!=null){  %>
            ...
            <%}%>
        <form action="/applicationPointage/Authentification"  method="post">
    <div class="myDiv1"> 
         <b style="padding-left: 14%">    bienvenue en espace salarié </b>
    <img src="/pffNetbeans/image/signin.png"  class="avatar">

    <br>
     <label id="lbl1"  > <b>email:</b>    </label>
     <input type="text" id="input1" name="fieldEmail"><br><br>
    
      <label    id="lbl2"> <b>password :</b>    </label>
      <input type="password"  id="input2" name="fieldMdp"><br><br>
